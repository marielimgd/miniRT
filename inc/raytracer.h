...
void				add_tuples(t_vector *result,\
						t_vector *vector, t_vector *point);
void				subtract_tuples(t_vector *result,\
						t_vector *vector, t_vector *point);
void				scale_tuples_product(t_vector *result,\
						t_vector *vector, double scale);
void				scale_tuples_divison(t_vector *result,\
						t_vector *vector, double scale);
...
int					handle_mouse_scroll(int button,\
						int x, int y, t_scene *scene);
...
void				prepare_computations(t_comps *comps,\
...
// --- Camera ---
void				camera_init(t_camera *cam, int hsize,\
