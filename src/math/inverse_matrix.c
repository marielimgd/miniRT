...
/*   Updated: 2025/09/12 16:40:59 by mmariano         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
t_matrix	*inverse_matrix(t_matrix *m)
{
	...
	det = 1.0 / det;
	inv->matrix[0][0] = b[0] * det; inv->matrix[0][1] = b[4] * det; inv->matrix[0][2] = b[8] * det; inv->matrix[0][3] = b[12] * det;
	inv->matrix[1][0] = b[1] * det; inv->matrix[1][1] = b[5] * det; inv->matrix[1][2] = b[9] * det; inv->matrix[1][3] = b[13] * det;
	inv->matrix[2][0] = b[2] * det; inv->matrix[2][1] = b[6] * det; inv->matrix[2][2] = b[10] * det; inv->matrix[2][3] = b[14] * det;
	inv->matrix[3][0] = b[3] * det; inv->matrix[3][1] = b[7] * det; inv->matrix[3][2] = b[11] * det; inv->matrix[3][3] = b[15] * det;
	return (inv);
}